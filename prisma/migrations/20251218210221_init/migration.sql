...
CREATE TABLE "conversation_metrics" (
    ...
    "leadFastestResponse" INTEGER,
    "messagesFromLead" INTEGER NOT NULL DEFAULT 0,
    "messagesFromAgent" INTEGER NOT NULL DEFAULT 0,
    "totalMessages" INTEGER NOT NULL DEFAULT 0,
    "mediaShared" INTEGER NOT NULL DEFAULT 0,
    "avgMessageLength" INTEGER,
    "conversationDuration" INTEGER,
    "basicLeadScore" INTEGER,
...
-- CreateIndex
CREATE INDEX "whatsapp_message_ticketId_idx" ON "whatsapp_message"("ticketId");
...
-- CreateIndex
CREATE INDEX "conversations_instanceId_idx" ON "conversations"("instanceId");
...
-- AddForeignKey
ALTER TABLE "whatsapp_message" ADD CONSTRAINT "whatsapp_message_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "tickets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
