...
const conversationTemplates = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        statusGroup: 'ACTIVE',
        probability: 40,
        suggestedMetaEventName: 'Contact',
      },
      {
      ...
      },
      {
        ...
        statusGroup: 'WON',
        probability: 100,
        suggestedMetaEventName: 'Purchase',
      },
  ...
  },
  {
    ...
    description:
      'Focado em processos que exigem qualificação e agendamento de reuniões ou visitas.',
    category: 'Vendas',
    icon: 'Users',
    isPopular: true,
    isDefault: false,
    items: [
      ...
      },
      {
        ...
        statusGroup: 'ACTIVE',
        probability: 30,
        suggestedMetaEventName: 'QualifiedLead',
      },
      {
        ...
        statusGroup: 'ACTIVE',
        probability: 60,
        suggestedMetaEventName: 'Schedule',
      },
  ...
  },
  {
    ...
    description:
      'Perfeito para clínicas, estética e prestadores de serviço com foco em reserva de horários.',
    category: 'Serviços',
    icon: 'Calendar',
    isPopular: false,
    isDefault: false,
  ...
  },
  {
    ...
    description:
      'Focado em converter leads que iniciaram uma compra mas não finalizaram o pagamento.',
    category: 'E-commerce',
    icon: 'ShoppingBag',
    isPopular: true,
    isDefault: false,
    items: [
      {
        ...
        statusGroup: 'ACTIVE',
        probability: 20,
        suggestedMetaEventName: 'InitiateCheckout',
      },
      {
  ...
  },
  {
    ...
    description:
      'Para empresas de software que oferecem degustação gratuita ou demonstração assistida.',
    category: 'Software',
    icon: 'Monitor',
    isPopular: false,
    isDefault: false,
    items: [
      ...
      },
      {
        ...
        statusGroup: 'ACTIVE',
        probability: 50,
        suggestedMetaEventName: 'StartTrial',
      },
      {
        name: 'Demo Realizada',
        color: '#0ea5e9',
