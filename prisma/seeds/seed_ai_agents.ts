...
6. A sua "confidence" deve ser um float de 0.0 a 1.0 (onde 1.00 é certeza absoluta).`,
    ...
    schemaFields: [
      ...
      },
      {
        ...
        fieldType: 'NUMBER',
        description:
          'Valor total negociado em número decimal (1500.00). Retorne sem moeda, apenas o numeral. Deixe nulo se não houver.',
        isRequired: false,
      },
      {
        fieldName: 'reasoning',
        fieldType: 'STRING',
        description:
          'Texto justificando a avaliação. Cite a evidência da conversa original ou como chegou no intent listado.',
        isRequired: true,
      },
      {
        ...
        fieldType: 'NUMBER',
        description:
          'A confiabilidade dessa extração. Valor float de 0.0 até 1.0 (onde 1.00 significa 100% garantido).',
        isRequired: true,
      },
    ],
  },
