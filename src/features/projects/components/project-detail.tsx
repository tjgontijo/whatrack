        ...
        <Card>
          ...
          <CardContent className='space-y-3'>
            {project.whatsappConfigs.length === 0 ? (
              <div className='rounded-xl border border-border border-dashed bg-muted/20 px-4 py-6 text-muted-foreground text-sm'>
                ...
                >
                  <div>
                    <p className='font-medium'>
                      {config.displayPhone ?? config.verifiedName ?? 'Número sem identificação'}
                    </p>
                    <p className='text-muted-foreground text-sm'>
              ...
              project.metaAdAccounts.map((account) => (
                ...
                >
                  <div>
                    ...
                    <p className='text-muted-foreground text-sm'>{account.adAccountId}</p>
                  </div>
