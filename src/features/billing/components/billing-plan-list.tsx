...
function buildPageHref(basePath: string, filters: BillingPlanListQuery, page: number) {
        ...
        <CardContent className='space-y-6'>
          ...
          <div className='grid gap-3 md:grid-cols-3'>
            <div className='rounded-xl border border-border bg-muted/30 p-4'>
              ...
              <p className='mt-2 font-semibold text-2xl'>{data.total}</p>
            </div>

            <div className='rounded-xl border border-border bg-muted/30 p-4'>
              <p className='text-muted-foreground text-xs uppercase tracking-wide'>Página atual</p>
            ...
            <div className='rounded-xl border border-border bg-muted/30 p-4'>
              ...
              <p className='mt-2 font-semibold text-2xl'>{data.pageSize}</p>
            </div>
          </div>
                    ...
                    <TableCell className='align-top'>
                      <div className='flex flex-col gap-1'>
                        <div className='flex items-center gap-2'>
                          ...
                          {plan.isHighlighted && <Badge variant='outline'>Destaque</Badge>}
                          {plan.contactSalesOnly && <Badge variant='outline'>Vendas</Badge>}
                        </div>
                        <span className='text-muted-foreground text-xs'>/{plan.slug}</span>
                        {plan.description && (
