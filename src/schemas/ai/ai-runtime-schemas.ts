...
export const aiBusinessHoursSchema = z
  .object({
...
export const aiRuntimeConfigQuerySchema = z.object({
  projectId: z.string().uuid().optional(),
})

export const updateAiRuntimeConfigSchema = z
  .object({
    projectId: z.string().uuid().optional(),
    ...
    businessHours: aiBusinessHoursSchema.nullable().optional(),
    debounceMs: z.number().int().min(1000).max(60000).optional(),
...
export type AiRuntimeConfigQuery = z.infer<typeof aiRuntimeConfigQuerySchema>
export type UpdateAiRuntimeConfigInput = z.infer<typeof updateAiRuntimeConfigSchema>
