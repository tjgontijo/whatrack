  ...
  return (
    <div className='relative min-h-screen overflow-hidden bg-zinc-950 text-white'>
      ...
      <div className='relative flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 lg:px-8'>
        ...
        >
          <h1 className='mb-4 font-bold font-geist text-4xl sm:text-5xl'>
        ...
        >
          {[
            ...
            >
              <div className='font-semibold text-emerald-400 text-sm'>{item.label}</div>
        ...
        >
          <Button
            ...
            className='h-12 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-8 font-semibold text-white shadow-emerald-500/25 shadow-lg hover:shadow-emerald-500/40 hover:shadow-xl'
          >
            Continuar
          </Button>
