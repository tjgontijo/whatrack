...
export function LandingFooter() {
  return (
    <footer className='relative overflow-hidden border-zinc-200 border-t bg-white dark:border-zinc-800 dark:bg-zinc-950'>
      ...
      <div className='relative mx-auto max-w-[1400px] px-6 py-16 sm:px-8 lg:px-12'>
        ...
        <div className='grid gap-12 lg:grid-cols-4'>
          ...
          <div className='space-y-6 lg:col-span-2'>
            ...
            <p className='max-w-sm text-base text-zinc-600 leading-relaxed dark:text-zinc-400'>
          ...
          <div className='space-y-4'>
            <h4 className='font-bold font-geist text-sm text-zinc-900 uppercase tracking-wider dark:text-white'>
              Empresa
            </h4>
        ...
        {/* Bottom bar */}
        <div className='mt-16 flex flex-col items-center justify-between gap-4 border-zinc-200 border-t pt-8 sm:flex-row dark:border-zinc-800'>
