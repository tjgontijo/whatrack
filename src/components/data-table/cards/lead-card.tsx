...
import { Inbox, ShoppingBag, MessageSquareText, ClipboardCheck } from 'lucide-react'
import {
  DataTableCard,
  DataTableCardHeader,
  DataTableCardTitle,
...
export const LeadCard = React.memo(
  React.forwardRef<HTMLDivElement, LeadCardProps>(({ lead, onOpenDialog, className }, ref) => {
