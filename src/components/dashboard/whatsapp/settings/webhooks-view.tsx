      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h1 className="text-foreground text-lg font-bold tracking-tight mb-0.5">Webhooks / WhatsApp</h1>
            <p className="text-muted-foreground text-xs mb-3">
              Monitore e configure a integração técnica com o WhatsApp Business API.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 -ml-3">
          <TabsList className="flex h-auto items-center gap-1 border-none bg-transparent p-0 shadow-none">
            <TabsTrigger
              value="overview"
              className="ring-offset-background focus-visible:ring-ring group relative flex items-center gap-2 px-3 py-2 text-xs font-medium outline-none transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 border-none bg-transparent shadow-none data-[state=active]:bg-transparent data-[state=active]:text-foreground text-muted-foreground hover:bg-muted/50 hover:text-foreground"
            >
